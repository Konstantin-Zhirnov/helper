export const getConfirmationTemplate = (name: string, url: string) => {
  return `<!DOCTYPE html>
...
<body style="background-color: #f5f5fa; margin: 0; padding: 0; -webkit-text-size-adjust: none; text-size-adjust: none;">
<table border="0" cellpadding="0" cellspacing="0" class="nl-container" role="presentation" style="mso-table-lspace: 0; mso-table-rspace: 0; background-color: #f5f5fa;" width="100%">
    <tbody>
    <tr>
        <td>
            <table align="center" border="0" cellpadding="0" cellspacing="0" class="row row-1" role="presentation" style="mso-table-lspace: 0; mso-table-rspace: 0pt; background-color: #d8e2f1;" width="100%">
                <tbody>
                <tr>
                    <td>
                            ...
                            <tr>
                                <td class="column column-1" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; padding-top: 5px; vertical-align: top; border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px;" width="100%">
                                    ...
                                    <table border="0" cellpadding="10" cellspacing="0" class="heading_block block-3" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;" width="100%">
                                        <tr>
                                            <td class="pad">
                                                <h1 style="margin: 0; color: #090f34; direction: ltr; font-family: Helvetica Neue, Helvetica, Arial, sans-serif; font-size: 39px; font-weight: normal; letter-spacing: normal; line-height: 120%; text-align: center; margin-top: 0; margin-bottom: 0; mso-line-height-alt: 46.8px;"><strong>Hi ${name}, <br/></strong></h1>
                                            </td>
                                        </tr>
                                    </table>
                                    <table border="0" cellpadding="10" cellspacing="0" class="heading_block block-4" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;" width="100%">
                                        <tr>
                                            <td class="pad">
                                                <h1 style="margin: 0; color: #090f34; direction: ltr; font-family: Helvetica Neue, Helvetica, Arial, sans-serif; font-size: 39px; font-weight: normal; letter-spacing: normal; line-height: 120%; text-align: center; margin-top: 0; mso-line-height-alt: 46.8px;"><strong>Welcome to the HELPER <br/></strong></h1>
                                            </td>
                                        </tr>
                                    </table>
                                    ...
                                    <table border="0" cellpadding="10" cellspacing="0" class="button_block block-7" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;" width="100%">
                                        <tr>
                                            <td class="pad">
                                                ...
                                                <!--[if mso]>
                                                    <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="{{url}}" style="height:67px;width:230px;v-text-anchor:middle;" arcsize="26%" strokeweight="0.75pt" strokecolor="#000000" fillcolor="#090f34">
                                                    <w:anchorlock/>
                                    ...
                                    <div class="spacer_block block-12" style="height:25px;line-height:25px;font-size:1px;"> </div>
                                    <div class="spacer_block block-13" style="height:25px;line-height:25px;font-size:1px;"> </div>
                                    <div class="spacer_block block-14" style="height:25px;line-height:25px;font-size:1px;"> </div>
                                    <div class="spacer_block block-15" style="height:25px;line-height:25px;font-size:1px;"> </div>
                                    <div class="spacer_block block-16" style="height:25px;line-height:25px;font-size:1px;"> </div>
