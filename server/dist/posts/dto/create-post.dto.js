...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'I wll help with the yard cleaning', description: 'Post`s name' }),
    __metadata("design:type", String)
...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'Nanaimo', description: 'Place for help' }),
    __metadata("design:type", String)
