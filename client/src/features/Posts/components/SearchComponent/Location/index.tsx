...
import {getLocations, setSearchComponentLocation} from "../../../model/slice";
      ...
      <div className={classes.container}>
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 29 29" fill="none">
          <g clipPath="url(#clip0_7_792)">
            <path d="M14.5 16.3125C13.6038 16.3125 12.7277 16.0467 11.9826 15.5488C11.2374 15.0509 10.6566 14.3433 10.3137 13.5153C9.97071 12.6873 9.88098 11.7762 10.0558 10.8972C10.2307 10.0183 10.6622 9.21088 11.2959 8.57717C11.9296 7.94346 12.737 7.5119 13.616 7.33706C14.495 7.16223 15.4061 7.25196 16.234 7.59492C17.062 7.93788 17.7697 8.51866 18.2676 9.26382C18.7655 10.009 19.0313 10.8851 19.0313 11.7812C19.0299 12.9826 18.552 14.1343 17.7026 14.9838C16.8531 15.8333 15.7013 16.3111 14.5 16.3125ZM14.5 9.0625C13.9623 9.0625 13.4366 9.22195 12.9895 9.52069C12.5424 9.81943 12.194 10.244 11.9882 10.7408C11.7824 11.2376 11.7286 11.7843 11.8335 12.3117C11.9384 12.839 12.1973 13.3235 12.5776 13.7037C12.9578 14.0839 13.4422 14.3429 13.9696 14.4478C14.497 14.5527 15.0436 14.4988 15.5404 14.293C16.0372 14.0873 16.4618 13.7388 16.7606 13.2917C17.0593 12.8446 17.2188 12.319 17.2188 11.7812C17.218 11.0604 16.9313 10.3694 16.4216 9.85968C15.9119 9.34998 15.2208 9.06329 14.5 9.0625Z" fill="#6E82A8"/>
        ...
        <Select options={locations} defaultValue={location} cb={handleChange} ml0/>
      </div>
  )
})
