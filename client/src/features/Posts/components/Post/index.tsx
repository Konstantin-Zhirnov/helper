...
const Post: React.FC<IProps> = React.memo(({
  ...
  return (
    <li className={classes.container}>
        ...
        {
            pathname === '/profile'
                ? <Images imagesSrcArray={memoizedImages} _id={_id} pathname={pathname} authorId={postAuthorId} />
                : !!images.length
                    ? <Images imagesSrcArray={memoizedImages} _id={_id} pathname={pathname} authorId={postAuthorId} />
                    : null
        }
